                ...
                <div class="col-lg-7 mx-auto">
                    ...
                    <div class="auth-form-light text-left p-5">
                        <div class="text-center">
                            <h1>Đăng ký</h1>
                            <h6 class="font-weight-light">Đăng ký để tiếp tục.</h6>
                        </div>
                        <form class="pt-3" method="post">
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-lg" placeholder="Tên" name="ten_nv">
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-lg" placeholder="Mật khẩu" name="mat_khau">
                                    </div>
                                </div>
                            </div>
